...
階段 1–17 均已完成並上線。**階段 18 憑證模型重構（每分配多 per-device 憑證）已完成（2026-06-04，待部署）**；**階段 19 一鍵安裝 Codex**（依賴 18）尚未動工。
...
> 階段 1–18 皆已完成（階段 18 憑證模型 2026-06-04 完成、待部署）；階段 19（Codex 安裝）為規劃中、尚未動工。
...
### 階段 18：憑證模型重構（每分配多 per-device 憑證）✅（2026-06-04 完成、待部署）
