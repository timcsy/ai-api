...
> **狀態**：階段 1–28、30 皆已上線、階段 29 增量 ①（embedding）+ ②（計費一般化 + OCR）已出貨（最新 rev 85；逐階段 rev / 細節見〈現狀〉與 `history/completed-phases-detail.md`）。
> 規劃中：階段 29 增量 ③（圖片 / TTS / STT / rerank 各小 phase）。
