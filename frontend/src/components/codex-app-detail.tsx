...
/** Phase 27/28: the Codex application detail — status + one-click install +
 * create-key shortcut (scoped to Agent-compatible allocations). */
export function CodexAppDetail() {
