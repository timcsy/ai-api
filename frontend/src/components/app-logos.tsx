/** Application logos for the 應用 storefront. Codex = the OpenAI mark. */
export function CodexLogo({ className = "h-8 w-8" }: { className?: string }) {
  // OpenAI "blossom" mark (single-color, currentColor) — nominative use for the
  // Codex application tile. Swap for an official asset if/when provided.
  return (
